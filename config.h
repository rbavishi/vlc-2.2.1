...
#define PACKAGE_STRING "vlc 2.2.2"
...
#define VERSION_MESSAGE "2.2.2 Weatherwax"

/* compiler */
#define VLC_COMPILER "gcc version 4.9.2 20150212 (Red Hat 4.9.2-6) (GCC)"

/* user who ran configure */
#define VLC_COMPILE_BY "rbavishi"

/* host which ran configure */
#define VLC_COMPILE_HOST "localhost.localdomain"
