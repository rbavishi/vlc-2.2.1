...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AbstractController_t, stringdata) + ofs \
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AdvControlsWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_AdvControlsWidget.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_InputControlsWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_InputControlsWidget.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ControlsWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ControlsWidget.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FullscreenControllerWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_MOC_LITERAL(4, 50, 11), // "setVoutList"
QT_MOC_LITERAL(5, 62, 15), // "vout_thread_t**"
QT_MOC_LITERAL(6, 78, 7), // "showFSC"
QT_MOC_LITERAL(7, 86, 11), // "planHideFSC"
QT_MOC_LITERAL(8, 98, 7), // "hideFSC"
QT_MOC_LITERAL(9, 106, 11), // "slowHideFSC"
QT_MOC_LITERAL(10, 118, 10), // "restoreFSC"
QT_MOC_LITERAL(11, 129, 9) // "centerFSC"

    },
    "FullscreenControllerWidget\0keyPressed\0"
    "\0QKeyEvent*\0setVoutList\0vout_thread_t**\0"
    "showFSC\0planHideFSC\0hideFSC\0slowHideFSC\0"
    "restoreFSC\0centerFSC"
};
#undef QT_MOC_LITERAL
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_FullscreenControllerWidget.stringdata))
