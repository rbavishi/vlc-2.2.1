...
#define SUB_SPLIT_KEY_TEXT N_("Subtitle-Split")
#define SUB_SPLIT_KEY_LONGTEXT N_("Select the hotkey for subtitle-splitting.")
...
#   define KEY_PLAY_CLEAR         "Ctrl+w"
    ...
    add_key( "key-sub-split", KEY_SUB_SPLIT, SUB_SPLIT_KEY_TEXT,
             SUB_SPLIT_KEY_LONGTEXT, true )
